...
\begin{abstract}
  ...
  实验结果表明，本文方法在时序图解析任务上显著超越开源基线模型并逼近前沿闭源模型的性能水平，为智能电子设计自动化工具的发展开辟了新的路径。
...
\begin{abstract*}
  ...
  Experimental results demonstrate that the proposed method significantly outperforms open-source baseline models and approaches the performance level of state-of-the-art proprietary models on the timing diagram parsing task, opening a new pathway for the development of intelligent Electronic Design Automation tools.
